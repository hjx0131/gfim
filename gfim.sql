...
INSERT INTO `gf_admin` (`id`, `username`, `nickname`, `password`, `salt`, `avatar`, `email`, `loginfailure`, `logintime`, `loginip`, `createtime`, `updatetime`, `token`, `status`) VALUES
(1, 'admin', 'Admin', '796a670a8d1776cc735eb87df78a6b18', 'nILKy6', '/assets/img/avatar.png', 'admin@admin.com', 0, 1583375058, '172.20.0.1', 1492186163, 1583375058, '38940008-c689-42de-a8e9-3cc00996bf47', 'normal');
...
INSERT INTO `gf_area` (`id`, `pid`, `shortname`, `name`, `mergename`, `level`, `pinyin`, `code`, `zip`, `first`, `lng`, `lat`) VALUES
...
--
-- 转存表中的数据 `gf_attachment`
--

INSERT INTO `gf_attachment` (`id`, `admin_id`, `user_id`, `url`, `imagewidth`, `imageheight`, `imagetype`, `imageframes`, `filesize`, `mimetype`, `extparam`, `createtime`, `updatetime`, `uploadtime`, `storage`, `sha1`) VALUES
...
(2, 1, 0, '/uploads/20200111/3e8db7179046515d3e16056d4263acf9.jpg', '138', '138', 'jpg', 0, 2295, 'image/jpeg', '{\"name\":\"d5ae42fd4ad7efbf486277329f1aea63.jpg\"}', 1578731456, 1578731456, 1578731456, 'local', '49bb3a9ae5316ab6b0393a9c9f047f81e1b62420'),
(3, 1, 0, '/uploads/20200111/805cfb42b911647467170fa076bea1f9.jpg', '756', '1008', 'jpg', 0, 49857, 'image/jpeg', '{\"name\":\"87d153caf7a9ff0664eef4e2d63e06f6.jpg\"}', 1578731463, 1578731463, 1578731463, 'local', '6c0b9bb5a99f5040e1917829487ac30cd9240b91'),
(4, 1, 0, '/uploads/20200214/0a27a6d9a7134d2c9fa8823517626f43.xls', '', '', 'xls', 0, 172544, 'application/vnd.ms-excel', '{\"name\":\"20200116182007.xls\"}', 1581649018, 1581649018, 1581649018, 'local', '4b8d8ca17be9400b665a7ffaeda79932e4c50ffb'),
(5, 1, 0, '/uploads/20200214/d551b312679f0c142c728aa958cdda45.jpg', '130', '130', 'jpg', 0, 2948, 'image/jpeg', '{\"name\":\"default_face.jpg\"}', 1581649038, 1581649038, 1581649038, 'local', 'c8577b85696e598f42743fe4ad4cbe0e6059f29a'),
(6, 1, 0, '/uploads/20200214/703474985a95c0ada82183f630e4ede4.xlsx', '', '', 'xlsx', 0, 20894, 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', '{\"name\":\"3.0\\u7cfb\\u7edf\\u5bfc\\u5165.xlsx\"}', 1581670786, 1581670786, 1581670786, 'local', '76812114d9e81cc8d35ce2a29d3a3ada680b4dd6');
...
--
-- 转存表中的数据 `gf_auth_group`
--

INSERT INTO `gf_auth_group` (`id`, `pid`, `name`, `rules`, `createtime`, `updatetime`, `status`) VALUES
...
--
-- 表的结构 `gf_auth_group_access`
--

CREATE TABLE `gf_auth_group_access` (
  `uid` int(10) UNSIGNED NOT NULL COMMENT '会员ID',
  `group_id` int(10) UNSIGNED NOT NULL COMMENT '级别ID'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='权限分组表' ROW_FORMAT=COMPACT;

--
-- 转存表中的数据 `gf_auth_group_access`
--

INSERT INTO `gf_auth_group_access` (`uid`, `group_id`) VALUES
(1, 1);
...
--
-- 转存表中的数据 `gf_auth_rule`
--

INSERT INTO `gf_auth_rule` (`id`, `type`, `pid`, `name`, `title`, `icon`, `condition`, `remark`, `ismenu`, `createtime`, `updatetime`, `weigh`, `status`) VALUES
...
(85, 'file', 0, 'command', '在线命令管理', 'fa fa-terminal', '', '', 1, 1578730748, 1578730748, 0, 'normal'),
(86, 'file', 85, 'command/index', '查看', 'fa fa-circle-o', '', '', 0, 1578730748, 1578730748, 0, 'normal'),
(87, 'file', 85, 'command/add', '添加', 'fa fa-circle-o', '', '', 0, 1578730748, 1578730748, 0, 'normal'),
(88, 'file', 85, 'command/detail', '详情', 'fa fa-circle-o', '', '', 0, 1578730748, 1578730748, 0, 'normal'),
(89, 'file', 85, 'command/execute', '运行', 'fa fa-circle-o', '', '', 0, 1578730748, 1578730748, 0, 'normal'),
(90, 'file', 85, 'command/del', '删除', 'fa fa-circle-o', '', '', 0, 1578730748, 1578730748, 0, 'normal'),
(91, 'file', 85, 'command/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1578730748, 1578730748, 0, 'normal'),
(92, 'file', 0, 'nota_apply', 'Nota apply', 'fa fa-circle-o', '', '', 1, 1578731394, 1578734665, 0, 'normal'),
(93, 'file', 92, 'nota_apply/index', '查看', 'fa fa-circle-o', '', '', 0, 1578731394, 1578731394, 0, 'normal'),
(94, 'file', 92, 'nota_apply/add', '添加', 'fa fa-circle-o', '', '', 0, 1578731394, 1578731394, 0, 'normal'),
(95, 'file', 92, 'nota_apply/edit', '编辑', 'fa fa-circle-o', '', '', 0, 1578731394, 1578731394, 0, 'normal'),
(96, 'file', 92, 'nota_apply/del', '删除', 'fa fa-circle-o', '', '', 0, 1578731394, 1578731394, 0, 'normal'),
(97, 'file', 92, 'nota_apply/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1578731394, 1578731394, 0, 'normal'),
(98, 'file', 0, 'example', '开发示例管理', 'fa fa-magic', '', '', 1, 1579504195, 1579504195, 0, 'normal'),
(99, 'file', 98, 'example/bootstraptable', '表格完整示例', 'fa fa-table', '', '', 1, 1579504195, 1579504195, 0, 'normal'),
(100, 'file', 99, 'example/bootstraptable/index', '查看', 'fa fa-circle-o', '', '', 0, 1579504195, 1579504195, 0, 'normal'),
(101, 'file', 99, 'example/bootstraptable/detail', '详情', 'fa fa-circle-o', '', '', 0, 1579504195, 1579504195, 0, 'normal'),
(102, 'file', 99, 'example/bootstraptable/change', '变更', 'fa fa-circle-o', '', '', 0, 1579504195, 1579504195, 0, 'normal'),
(103, 'file', 99, 'example/bootstraptable/del', '删除', 'fa fa-circle-o', '', '', 0, 1579504195, 1579504195, 0, 'normal'),
(104, 'file', 99, 'example/bootstraptable/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1579504195, 1579504195, 0, 'normal'),
(105, 'file', 98, 'example/customsearch', '自定义搜索', 'fa fa-table', '', '', 1, 1579504195, 1579504195, 0, 'normal'),
(106, 'file', 105, 'example/customsearch/index', '查看', 'fa fa-circle-o', '', '', 0, 1579504195, 1579504195, 0, 'normal'),
(107, 'file', 105, 'example/customsearch/del', '删除', 'fa fa-circle-o', '', '', 0, 1579504195, 1579504195, 0, 'normal'),
(108, 'file', 105, 'example/customsearch/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1579504195, 1579504195, 0, 'normal'),
(109, 'file', 98, 'example/customform', '自定义表单示例', 'fa fa-edit', '', '', 1, 1579504195, 1579504195, 0, 'normal'),
(110, 'file', 109, 'example/customform/index', '查看', 'fa fa-circle-o', '', '', 0, 1579504195, 1579504195, 0, 'normal'),
(111, 'file', 98, 'example/tablelink', '表格联动示例', 'fa fa-table', '', '', 1, 1579504195, 1579504195, 0, 'normal'),
(112, 'file', 111, 'example/tablelink/index', '查看', 'fa fa-circle-o', '', '', 0, 1579504195, 1579504195, 0, 'normal'),
(113, 'file', 98, 'example/colorbadge', '彩色角标', 'fa fa-table', '', '', 1, 1579504195, 1579504195, 0, 'normal'),
(114, 'file', 113, 'example/colorbadge/index', '查看', 'fa fa-circle-o', '', '', 0, 1579504195, 1579504195, 0, 'normal'),
(115, 'file', 113, 'example/colorbadge/del', '删除', 'fa fa-circle-o', '', '', 0, 1579504195, 1579504195, 0, 'normal'),
(116, 'file', 113, 'example/colorbadge/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1579504195, 1579504195, 0, 'normal'),
(117, 'file', 98, 'example/controllerjump', '控制器间跳转', 'fa fa-table', '', '', 1, 1579504195, 1579504195, 0, 'normal'),
(118, 'file', 117, 'example/controllerjump/index', '查看', 'fa fa-circle-o', '', '', 0, 1579504195, 1579504195, 0, 'normal'),
(119, 'file', 117, 'example/controllerjump/del', '删除', 'fa fa-circle-o', '', '', 0, 1579504195, 1579504195, 0, 'normal'),
(120, 'file', 117, 'example/controllerjump/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1579504195, 1579504195, 0, 'normal'),
(121, 'file', 98, 'example/cxselect', '多级联动', 'fa fa-table', '', '', 1, 1579504195, 1579504195, 0, 'normal'),
(122, 'file', 121, 'example/cxselect/index', '查看', 'fa fa-circle-o', '', '', 0, 1579504195, 1579504195, 0, 'normal'),
(123, 'file', 121, 'example/cxselect/del', '删除', 'fa fa-circle-o', '', '', 0, 1579504195, 1579504195, 0, 'normal'),
(124, 'file', 121, 'example/cxselect/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1579504195, 1579504195, 0, 'normal'),
(125, 'file', 98, 'example/multitable', '多表格示例', 'fa fa-table', '', '', 1, 1579504195, 1579504195, 0, 'normal'),
(126, 'file', 125, 'example/multitable/index', '查看', 'fa fa-circle-o', '', '', 0, 1579504195, 1579504195, 0, 'normal'),
(127, 'file', 125, 'example/multitable/del', '删除', 'fa fa-circle-o', '', '', 0, 1579504195, 1579504195, 0, 'normal'),
(128, 'file', 125, 'example/multitable/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1579504195, 1579504195, 0, 'normal'),
(129, 'file', 98, 'example/relationmodel', '关联模型示例', 'fa fa-table', '', '', 1, 1579504195, 1579504195, 0, 'normal'),
(130, 'file', 129, 'example/relationmodel/index', '查看', 'fa fa-circle-o', '', '', 0, 1579504195, 1579504195, 0, 'normal'),
(131, 'file', 129, 'example/relationmodel/del', '删除', 'fa fa-circle-o', '', '', 0, 1579504195, 1579504195, 0, 'normal'),
(132, 'file', 129, 'example/relationmodel/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1579504195, 1579504195, 0, 'normal'),
(133, 'file', 98, 'example/tabletemplate', '表格模板示例', 'fa fa-table', '', '', 1, 1579504195, 1579504195, 0, 'normal'),
(134, 'file', 133, 'example/tabletemplate/index', '查看', 'fa fa-circle-o', '', '', 0, 1579504195, 1579504195, 0, 'normal'),
(135, 'file', 133, 'example/tabletemplate/detail', '详情', 'fa fa-circle-o', '', '', 0, 1579504195, 1579504195, 0, 'normal'),
(136, 'file', 133, 'example/tabletemplate/del', '删除', 'fa fa-circle-o', '', '', 0, 1579504195, 1579504195, 0, 'normal'),
(137, 'file', 133, 'example/tabletemplate/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1579504195, 1579504195, 0, 'normal'),
(138, 'file', 98, 'example/baidumap', '百度地图示例', 'fa fa-map-pin', '', '', 1, 1579504195, 1579504195, 0, 'normal'),
(139, 'file', 138, 'example/baidumap/index', '查看', 'fa fa-circle-o', '', '', 0, 1579504195, 1579504195, 0, 'normal'),
(140, 'file', 138, 'example/baidumap/map', '详情', 'fa fa-circle-o', '', '', 0, 1579504195, 1579504195, 0, 'normal'),
(141, 'file', 138, 'example/baidumap/del', '删除', 'fa fa-circle-o', '', '', 0, 1579504195, 1579504195, 0, 'normal'),
(142, 'file', 0, 'third', '第三方登录管理', 'fa fa-users', '', '', 1, 1581650128, 1581650128, 0, 'normal'),
(143, 'file', 142, 'third/index', '查看', 'fa fa-circle-o', '', '', 0, 1581650128, 1581650128, 0, 'normal'),
(144, 'file', 142, 'third/del', '删除', 'fa fa-circle-o', '', '', 0, 1581650128, 1581650128, 0, 'normal'),
(145, 'file', 0, 'litestore', '移动端商城', 'fa fa-shopping-basket', '', '', 1, 1581660719, 1581660719, 0, 'normal'),
(146, 'file', 145, 'litestorenews', '首页banner', 'fa fa-image', '', '', 1, 1581660719, 1581660719, 0, 'normal'),
(147, 'file', 146, 'litestorenews/index', '查看', 'fa fa-circle-o', '', '', 0, 1581660719, 1581660719, 0, 'normal'),
(148, 'file', 146, 'litestorenews/add', '添加', 'fa fa-circle-o', '', '', 0, 1581660719, 1581660719, 0, 'normal'),
(149, 'file', 146, 'litestorenews/edit', '修改', 'fa fa-circle-o', '', '', 0, 1581660719, 1581660719, 0, 'normal'),
(150, 'file', 146, 'litestorenews/del', '删除', 'fa fa-circle-o', '', '', 0, 1581660719, 1581660719, 0, 'normal'),
(151, 'file', 146, 'litestorenews/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1581660719, 1581660719, 0, 'normal'),
(152, 'file', 145, 'litestoregoods', '商品设置', 'fa fa-gift', '', '', 1, 1581660719, 1581660719, 0, 'normal'),
(153, 'file', 152, 'litestoregoods/index', '查看', 'fa fa-circle-o', '', '', 0, 1581660719, 1581660719, 0, 'normal'),
(154, 'file', 152, 'litestoregoods/add', '添加', 'fa fa-circle-o', '', '', 0, 1581660719, 1581660719, 0, 'normal'),
(155, 'file', 152, 'litestoregoods/edit', '修改', 'fa fa-circle-o', '', '', 0, 1581660719, 1581660719, 0, 'normal'),
(156, 'file', 152, 'litestoregoods/del', '删除', 'fa fa-circle-o', '', '', 0, 1581660719, 1581660719, 0, 'normal'),
(157, 'file', 152, 'litestoregoods/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1581660719, 1581660719, 0, 'normal'),
(158, 'file', 152, 'litestoregoods/addSpec', '增加规格', 'fa fa-circle-o', '', '', 0, 1581660719, 1581660719, 0, 'normal'),
(159, 'file', 152, 'litestoregoods/addSpecValue', '增加规格值', 'fa fa-circle-o', '', '', 0, 1581660719, 1581660719, 0, 'normal'),
(160, 'file', 145, 'litestorecategory', '商品分类', 'fa fa-th', '', '', 1, 1581660719, 1581660719, 0, 'normal'),
(161, 'file', 160, 'litestorecategory/index', '查看', 'fa fa-circle-o', '', '', 0, 1581660719, 1581660719, 0, 'normal'),
(162, 'file', 160, 'litestorecategory/add', '添加', 'fa fa-circle-o', '', '', 0, 1581660719, 1581660719, 0, 'normal'),
(163, 'file', 160, 'litestorecategory/edit', '修改', 'fa fa-circle-o', '', '', 0, 1581660719, 1581660719, 0, 'normal'),
(164, 'file', 160, 'litestorecategory/del', '删除', 'fa fa-circle-o', '', '', 0, 1581660719, 1581660719, 0, 'normal'),
(165, 'file', 160, 'litestorecategory/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1581660719, 1581660719, 0, 'normal'),
(166, 'file', 145, 'litestorefreight', '运费模板设置', 'fa fa-train', '', '', 1, 1581660719, 1581660719, 0, 'normal'),
(167, 'file', 166, 'litestorefreight/index', '查看', 'fa fa-circle-o', '', '', 0, 1581660719, 1581660719, 0, 'normal'),
(168, 'file', 166, 'litestorefreight/add', '添加', 'fa fa-circle-o', '', '', 0, 1581660719, 1581660719, 0, 'normal'),
(169, 'file', 166, 'litestorefreight/edit', '修改', 'fa fa-circle-o', '', '', 0, 1581660719, 1581660719, 0, 'normal'),
(170, 'file', 166, 'litestorefreight/del', '删除', 'fa fa-circle-o', '', '', 0, 1581660719, 1581660719, 0, 'normal'),
(171, 'file', 166, 'litestorefreight/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1581660719, 1581660719, 0, 'normal'),
(172, 'file', 145, 'litestoreorder', '订单管理', 'fa fa-tasks', '', '', 1, 1581660719, 1581660719, 0, 'normal'),
(173, 'file', 172, 'litestoreorder/index', '查看', 'fa fa-circle-o', '', '', 0, 1581660719, 1581660719, 0, 'normal'),
(174, 'file', 172, 'litestoreorder/add', '添加', 'fa fa-circle-o', '', '', 0, 1581660719, 1581660719, 0, 'normal'),
(175, 'file', 172, 'litestoreorder/edit', '修改', 'fa fa-circle-o', '', '', 0, 1581660719, 1581660719, 0, 'normal'),
(176, 'file', 172, 'litestoreorder/del', '删除', 'fa fa-circle-o', '', '', 0, 1581660719, 1581660719, 0, 'normal'),
(177, 'file', 172, 'litestoreorder/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1581660719, 1581660719, 0, 'normal'),
(178, 'file', 172, 'litestoreorder/detail', '订单详情', 'fa fa-circle-o', '', '', 0, 1581660719, 1581660719, 0, 'normal'),
(179, 'file', 2, 'general/database', '数据库管理', 'fa fa-database', '', '可在线进行一些简单的数据库表优化或修复，查看表结构和数据，也可以进行SQL语句的操作', 1, 1581662965, 1581662965, 0, 'normal'),
(180, 'file', 179, 'general/database/index', '查看', 'fa fa-circle-o', '', '', 0, 1581662965, 1581662965, 0, 'normal'),
(181, 'file', 179, 'general/database/query', '查询', 'fa fa-circle-o', '', '', 0, 1581662965, 1581662965, 0, 'normal'),
(182, 'file', 179, 'general/database/backup', '备份', 'fa fa-circle-o', '', '', 0, 1581662965, 1581662965, 0, 'normal'),
(183, 'file', 179, 'general/database/restore', '恢复', 'fa fa-circle-o', '', '', 0, 1581662965, 1581662965, 0, 'normal'),
(184, 'file', 0, 'testdata', 'Testdata', 'fa fa-circle-o', '', '', 1, 1581664728, 1581664728, 0, 'normal'),
(185, 'file', 184, 'testdata/index', '查看', 'fa fa-circle-o', '', '', 0, 1581664728, 1581666274, 0, 'normal'),
(186, 'file', 184, 'testdata/recyclebin', '回收站', 'fa fa-circle-o', '', '', 0, 1581664728, 1581666274, 0, 'normal'),
(187, 'file', 184, 'testdata/add', '添加', 'fa fa-circle-o', '', '', 0, 1581664728, 1581666274, 0, 'normal'),
(188, 'file', 184, 'testdata/edit', '编辑', 'fa fa-circle-o', '', '', 0, 1581664728, 1581666274, 0, 'normal'),
(189, 'file', 184, 'testdata/del', '删除', 'fa fa-circle-o', '', '', 0, 1581664728, 1581666274, 0, 'normal'),
(190, 'file', 184, 'testdata/destroy', '真实删除', 'fa fa-circle-o', '', '', 0, 1581664728, 1581666274, 0, 'normal'),
(191, 'file', 184, 'testdata/restore', '还原', 'fa fa-circle-o', '', '', 0, 1581664728, 1581666274, 0, 'normal'),
(192, 'file', 184, 'testdata/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1581664728, 1581666274, 0, 'normal'),
(193, 'file', 66, 'user/moneylog', '会员余额日志', 'fa fa-money', '', '', 1, 1582013892, 1582013892, 0, 'normal'),
(194, 'file', 193, 'user/moneylog/index', '查看', 'fa fa-circle-o', '', '', 0, 1582013892, 1582013892, 0, 'normal'),
(195, 'file', 193, 'user/moneylog/add', '添加', 'fa fa-circle-o', '', '', 0, 1582013892, 1582013892, 0, 'normal'),
(196, 'file', 193, 'user/moneylog/edit', '修改', 'fa fa-circle-o', '', '', 0, 1582013892, 1582013892, 0, 'normal'),
(197, 'file', 193, 'user/moneylog/del', '删除', 'fa fa-circle-o', '', '', 0, 1582013892, 1582013892, 0, 'normal'),
(198, 'file', 193, 'user/moneylog/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1582013892, 1582013892, 0, 'normal'),
(199, 'file', 66, 'user/scorelog', '会员积分日志', 'fa fa-circle-o', '', '', 1, 1582013892, 1582013892, 0, 'normal'),
(200, 'file', 199, 'user/scorelog/index', '查看', 'fa fa-circle-o', '', '', 0, 1582013892, 1582013892, 0, 'normal'),
(201, 'file', 199, 'user/scorelog/add', '添加', 'fa fa-circle-o', '', '', 0, 1582013892, 1582013892, 0, 'normal'),
(202, 'file', 199, 'user/scorelog/edit', '修改', 'fa fa-circle-o', '', '', 0, 1582013892, 1582013892, 0, 'normal'),
(203, 'file', 199, 'user/scorelog/del', '删除', 'fa fa-circle-o', '', '', 0, 1582013892, 1582013892, 0, 'normal'),
(204, 'file', 199, 'user/scorelog/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1582013892, 1582013892, 0, 'normal');
...
INSERT INTO `gf_category` (`id`, `pid`, `type`, `name`, `nickname`, `flag`, `image`, `keywords`, `description`, `diyname`, `createtime`, `updatetime`, `weigh`, `status`) VALUES
...
INSERT INTO `gf_config` (`id`, `name`, `group`, `title`, `tip`, `type`, `value`, `content`, `rule`, `extend`) VALUES
...
-- 表的索引 `gf_attachment`
--
ALTER TABLE `gf_attachment`
  ADD PRIMARY KEY (`id`);

--
-- 表的索引 `gf_auth_group`
--
ALTER TABLE `gf_auth_group`
  ADD PRIMARY KEY (`id`);

--
-- 表的索引 `gf_auth_group_access`
--
ALTER TABLE `gf_auth_group_access`
...
--
ALTER TABLE `gf_area`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'ID', AUTO_INCREMENT=3750;

--
-- 使用表AUTO_INCREMENT `gf_attachment`
--
ALTER TABLE `gf_attachment`
  MODIFY `id` int(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID', AUTO_INCREMENT=7;

--
-- 使用表AUTO_INCREMENT `gf_auth_group`
--
ALTER TABLE `gf_auth_group`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- 使用表AUTO_INCREMENT `gf_auth_rule`
--
ALTER TABLE `gf_auth_rule`
