    ...
    function (i) {
        ...
        var x, b, w, k, C, S = function (i, a, n) {
            ...
            M = function (i, a) {
                ...
                if (a) {
                    i.hasClass(o) && M(0 === n ? i.next() : i.prev()),
                        i.remove(),
                        r.remove();
            ...
            Y = function (i) {
                ...
                var a = e(".layim-chatlist-" + i.type + i.id),
                    t = {},
                    l = a.index();
                if (i.timestamp = i.timestamp || (new Date).getTime(), i.fromid == j.mine.id && (i.mine = !0), i.system || B(i), K = JSON.parse(JSON.stringify(i)), j.base.voice && G(), !w && i.content || l === -1) {
            ...
            ei = {
                    ...
                    var a = x.find(".layui-layim-search"),
                        ...
                        n = function (i) {
                            ...
                            if ("" === a) ei.tab(0 | ei.tab.index);
                                ...
                                for (var n = [], l = j.friend || [], s = j.group || [], o = "", r = 0; r < l.length; r++) for (var d = 0; d < (l[r].list || []).length; d++) l[r].list[d].username.indexOf(a) !== -1 && (l[r].list[d].type = "friend", l[r].list[d].index = r, l[r].list[d].list = d, n.push(l[r].list[d]));
                ...
                setSend: function (i, a) {
                    ...
                    if ("show" === n) X(a),
                        t.show().addClass(ai),
                        e(document).off("click", ei.setSendHide).on("click", ei.setSendHide);
                    else {
                        i.addClass(o).siblings().removeClass(o);
        ...
        i("layim", new c)
    }).addcss("modules/layim/layim.css?v=3.01Pro", "skinlayimcss");