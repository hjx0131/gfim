...
// arModel is a active record design model for table gf_admin_log operations.
type arModel struct {
	M *gdb.Model
}

var (
	// Table is the table name of gf_admin_log.
	Table = "gf_admin_log"
	// Model is the model object of gf_admin_log.
