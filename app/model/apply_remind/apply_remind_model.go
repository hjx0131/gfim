...
// arModel is a active record design model for table gf_apply_remind operations.
type arModel struct {
	M *gdb.Model
}

var (
	// Table is the table name of gf_apply_remind.
	Table = "gf_apply_remind"
	// Model is the model object of gf_apply_remind.
