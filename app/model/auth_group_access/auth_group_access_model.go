...
// arModel is a active record design model for table gf_auth_group_access operations.
type arModel struct {
	M *gdb.Model
}

var (
	// Table is the table name of gf_auth_group_access.
	Table = "gf_auth_group_access"
	// Model is the model object of gf_auth_group_access.
