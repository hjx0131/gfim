...
// arModel is a active record design model for table gf_user_token operations.
type arModel struct {
	M *gdb.Model
}

var (
	// Table is the table name of gf_user_token.
	Table = "gf_user_token"
	// Model is the model object of gf_user_token.
