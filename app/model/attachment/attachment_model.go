...
// arModel is a active record design model for table gf_attachment operations.
type arModel struct {
	M *gdb.Model
}

var (
	// Table is the table name of gf_attachment.
	Table = "gf_attachment"
	// Model is the model object of gf_attachment.
