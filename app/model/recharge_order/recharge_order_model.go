...
// arModel is a active record design model for table gf_recharge_order operations.
type arModel struct {
	M *gdb.Model
}

var (
	// Table is the table name of gf_recharge_order.
	Table = "gf_recharge_order"
	// Model is the model object of gf_recharge_order.
