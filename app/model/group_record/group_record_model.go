...
// arModel is a active record design model for table gf_group_record operations.
type arModel struct {
	M *gdb.Model
}

var (
	// Table is the table name of gf_group_record.
	Table = "gf_group_record"
	// Model is the model object of gf_group_record.
