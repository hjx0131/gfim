...
// arModel is a active record design model for table gf_friend_group operations.
type arModel struct {
	M *gdb.Model
}

var (
	// Table is the table name of gf_friend_group.
	Table = "gf_friend_group"
	// Model is the model object of gf_friend_group.
