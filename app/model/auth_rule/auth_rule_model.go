...
// arModel is a active record design model for table gf_auth_rule operations.
type arModel struct {
	M *gdb.Model
}

var (
	// Table is the table name of gf_auth_rule.
	Table = "gf_auth_rule"
	// Model is the model object of gf_auth_rule.
