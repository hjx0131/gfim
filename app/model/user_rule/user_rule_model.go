...
// arModel is a active record design model for table gf_user_rule operations.
type arModel struct {
	M *gdb.Model
}

var (
	// Table is the table name of gf_user_rule.
	Table = "gf_user_rule"
	// Model is the model object of gf_user_rule.
